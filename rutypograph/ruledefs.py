...
RULEDEF_QUOTES = [
    ...
    },
    {
        ...
        "pattern": "/(^|\\(|\\s|\\>|-)((\\\"|\\\\\")+)(\\S+)/iue",
        "replacement": lambda m: m.group(1) + QUOTE_FIRS_OPEN * (m.group(2).count("\"")) + m.group(4)
    },
    {
        "rule_id": "close_quote",
        "description": "Закрывающая кавычка",
        "pattern": "/([a-zа-яё0-9]|\\.|\\&hellip\\;|\\!|\\?|\\>|\\)|\\:|\\+|\\%|\\@|\\#|\\$|\\*)((\\\"|\\\\\")+)(\\.|\\&hellip\\;|\\;|\\:|\\?|\\!|\\,|\\s|\\)|\\<\\/|\\<|$)/uie",
        "replacement": lambda m: m.group(1) + QUOTE_FIRS_CLOSE * (m.group(2).count("\"")) + m.group(4)
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + QUOTE_FIRS_CLOSE * (m.group(2).count("\"") + m.group(2).count("&laquo;")) + m.group(
                    4) + m.group(5),
            lambda m: m.group(1) + m.group(2) + QUOTE_FIRS_CLOSE * (
            ...
            ">&raquo;;\\2",
            ">&raquo;)\\2",
            lambda m: QUOTE_FIRS_CLOSE * (m.group(1).count("\""))
        ]
    },
    {
        ...
        "pattern": "/(^|\\(|\\s|\\>)(\\\"|\\\\\")(\\s)(\\S+)/iue",
        "replacement": lambda m: m.group(1) + QUOTE_FIRS_OPEN + m.group(4)
    },
    {
...
RULEDEF_TEXT = [
    # Эти правила удалены, так как это HTML разметка
]
RULEDEF_ETC = [
    {
    ...
    },
    {
        ...
        "replacement": lambda m: "" + wrap_in_typo_sup(m.group(3)) + m.group(4)
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + "&mdash;" + m.group(4) + " вв.")
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + "&mdash;" + m.group(4)) + m.group(5)
    },
    {
        "rule_id": "split_number_to_triads",
        "description": "Разбиение числа на триады",
        "pattern": "/([^a-zA-Z0-9<\\)]|^)([0-9]{5,})([^a-zA-Z>\\(]|$)/eu",
        "replacement": lambda m: m.group(1) + util_strreplace(" ", "&thinsp;", util_split_number(m.group(2))) + m.group(
                3)
    },
    # {
...
RULEDEF_OPTS = [
    ...
    #     ],
    #     "replacement": [
    #         lambda m: m.group(1) + make_tag(m.group(2), "span", {"class": "oa_oqoute_sp_s"}) + make_tag(m.group(3),
    #                                                                                                     "span",
    #                                                                                       { "class": "oa_oqoute_sp_q"}),
    #         lambda m: m.group(1) + make_tag(m.group(2), "span", {"class": "oa_oquote_nl"})
    #     ]
    # },
    # {
    ...
    #     ],
    #     "replacement": [
    #         lambda m: make_tag(m.group(1), "span", {"class": "oa_obracket_sp_s"}) + make_tag("(", "span", {
    #             "class": "oa_obracket_sp_b"}),
    #         lambda m: m.group(1) + make_tag("(", "span", {"class": "oa_obracket_nl_b"})
    #     ]
    # }
]
RULEDEF_DATES = [
    {
        ...
        "replacement": lambda m: m.group(1) + m.group(2) + ((
            m.group(3) + m.group(4) + m.group(5) if int(m.group(3)) >= int(
                    m.group(5)) else  m.group(3) + "&mdash;" + m.group(5))) + (
    ...
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(
                m.group(2) + "&mdash;" + m.group(4) + " " + m.group(6)) + m.group(7)
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + " г.") + (
                ("" if m.group(5) == "." else " ")),
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2)) + m.group(4)
        ]
    },
    {
...
RULEDEF_NOBR = [
    {
        ...
        "replacement": lambda m: m.group(1) + m.group(3).strip() + "&nbsp;" + (
    ...
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(
                "+" + m.group(2) + " " + m.group(3) + " " + m.group(4) + "-" + m.group(5) + "-" + m.group(6)) + m.group(
                7)
    },
    {
        "rule_id": "ip_address",
        ...
        "replacement": lambda m: m.group(1) + utils_nowrap_ip_address(m.group(2))
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + ". " + m.group(4) + ". " + m.group(6)) + m.group(7),
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + " " + m.group(4) + ". " + m.group(6) + ".") + m.group(7)
        ]
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + ". " + m.group(4) + ". " + m.group(6)) + m.group(7),
            lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + " " + m.group(4) + ". " + m.group(6) + ".") + m.group(7),
            lambda m: m.group(1) + wrap_in_nowrap(
                    m.group(2) + ((" " if (m.group(3)) else  "")) + m.group(4) + (
                        (" " if (m.group(5)) else  "")) + m.group(6)) + m.group(7),
            lambda m: m.group(1) + wrap_in_nowrap(
                    m.group(2) + " " + m.group(4) + ((" " if (m.group(5)) else  "")) + m.group(6)) + m.group(7)
        ]
    },
    {
        ...
        "replacement": lambda m: "&nbsp;" + m.group(2) + ((" " if m.group(3) == "&nbsp;"  else  m.group(3)))
    },
    {
    ...
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(m.group(2)) + m.group(4)
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + m.group(3)) + m.group(6)
    }
]
RULEDEF_ABBR = [
    {
    ...
    },
    {
        ...
        "pattern": "/(^|\\040|\\t|\\>|\\r|\\n)(p\\.\\040?)(p\\.\\040?)?(s\\.)([^\\<])/ie",
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(
                m.group(2).strip() + " " + ((m.group(3).strip() + " " if m.group(3)  else  "")) + m.group(4)) + m.group(
                5)
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + wrap_in_nowrap("и т. д.") + (
                (m.group(3) if m.group(3) != "." else  "")),
            lambda m: m.group(1) + wrap_in_nowrap("и т. п.") + (
                (m.group(3) if m.group(3) != "." else  "")),
            lambda m: m.group(1) + wrap_in_nowrap("в т. ч.") + (
                (m.group(3) if m.group(3) != "." else  ""))
        ]
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_nowrap(m.group(2) + ". е.")
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + wrap_in_nowrap(
                    "ГОСТ " + m.group(3) + (("&ndash;" + m.group(6) if (m.group(6)) else "")) + (
                        (" &mdash;" if (m.group(7)) else ""))),
            lambda m: m.group(1) + "ГОСТ " + m.group(3) + "&ndash;" + m.group(5)
        ]
    }
]
RULEDEF_SPACE = [
    ...
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + m.group(2) + "." + (("" if m.group(5) == "."  else  " ")) + m.group(4) + m.group(5),
            lambda m: m.group(1) + m.group(2) + "." + (
                ("" if util_lowercase(m.group(3)) in (DOMAINS) else (("" if m.group(4) == "."  else  " ")))) + m.group(
                    3) + m.group(4)
        ]
    },
    {
...
RULEDEF_NUMBERS = [
    ...
    },
    {
        ...
        "replacement": lambda m: m.group(1) + "&minus;" + m.group(3) + m.group(4) + m.group(5) + (
            (m.group(6) if m.group(6) == "+" else "&minus;")) + m.group(7)
    },
    {
        #fix for python <3.5 issue unmatched group
    ...
    },
    {
        ...
        "replacement": lambda m: m.group(1) + wrap_in_typo_sub(m.group(2)) + m.group(3)
    },
    {
        "rule_id": "numeric_sup",
        "description": "Верхний индекс",
        "pattern": "/([a-zа-яё0-9])\\^([\\d]{1,3})([^а-яёa-z0-9]|$)/ieu",
        "replacement": lambda m: m.group(1) + wrap_in_typo_sup(m.group(2), "small") + m.group(3)
    },
    {
    ...
    },
    {
        ...
        "replacement": lambda m: (
            (m.group(0) if m.group(3) == "-" else util_strreplace(" ", "&thinsp;", m.group(1)) + m.group(3)))
    },
    {
...
RULEDEF_SYMBOLS = [
    ...
    },
    {
        ...
        "replacement": [
            lambda m: m.group(1) + "&reg;" + m.group(2)
        ]
    },
    {
    ...
    },
    {
        ...
        "replacement": lambda m: "" + wrap_in_nowrap(m.group(1) + " &deg;F") + m.group(2)
    },
    {
        "rule_id": "euro_symbol",
...
RULEDEF_DASH = [
    ...
    },
    {
        ...
        "replacement": lambda m: ((" " if m.group(1) == "&nbsp;"  else  m.group(1))) + m.group(2) + "-" + m.group(
    ...
    },
    {
        ...
        "replace_callback": lambda m: ((" " if m.group(1) == "&nbsp;"  else  m.group(1))) + m.group(2) + "-" + m.group(
                4) + ((" " if m.group(5) == "&nbsp;" else  m.group(5)))
    },
    {
        "rule_id": "ka_de_kas",
